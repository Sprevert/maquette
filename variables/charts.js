...
let chartVenteNew = {
	...
	data: (canvas) => {
		return {
			labels: ["Sept.", "Oct.", "Nov.", "Déc.", "Janv.", "Févr.", "Avril"],
			datasets: [
				{
					label: "Ventes",
					data: [ 0, 0, 0, 0, 0, 0, 86754],
				},
			],
		};
	},
	...
	data: (canvas) => {
		return {
			...
			datasets: [
				{
					label: "Ventes",
					data: [ 371, 219, 240, 536, 248, 191, 115],
				},
			],
		};
	},
...
module.exports = {
	...
	chartVenteOld, // used inside src/views/Article.js
	chartVenteNew, // used inside src/views/Article.js
};
